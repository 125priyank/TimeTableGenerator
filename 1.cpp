...
map<string, map<int, string>> returnMapData (map<string, tuple<string, string, int, int> > a, map<string, string> b)
{

	
  // Course Code and their type and count
  map<string, tuple<string, string, int, int>> courseCode = a;

  // Teacher Code and their subject course code
  map<string, string> teacherCode = b;
